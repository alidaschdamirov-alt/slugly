...
export default function Team() {
  ...
  const { data: wsInfo } = trpc.workspace.current.useQuery(undefined, { refetchOnWindowFocus: false });
  const { data: members } = trpc.workspace.members.useQuery(undefined, { refetchOnWindowFocus: false });
  const { data: invitations } = trpc.workspace.invitations.useQuery(undefined, { refetchOnWindowFocus: false });
