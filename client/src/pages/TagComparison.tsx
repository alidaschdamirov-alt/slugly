  ...
  return (
    <AppShell>
      <div className="space-y-6">
        ...
        ) : !canCompareTags || isGated ? (
          <FeatureGateCard
            title="Tag comparison requires Starter"
            description="Compare tag performance, discover which campaigns drive the most clicks, and analyze trends across multiple tagged links."
            requiredPlan="Starter"
            featureLabel="Tag comparison"
          />
        ) : (
          <>
